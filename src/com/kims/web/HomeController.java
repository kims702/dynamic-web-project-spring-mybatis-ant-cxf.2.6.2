...
public class HomeController {
	...
	public String index(Locale locale, Model model) {
		...
		System.out.println("###################____________________ant clean build deploy >> index ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
...
//	  modelAndView.addObject("age",requestShop.getAge());
	...
	/*
	 * @RequestMapping(value="/getProcessPost", method=RequestMethod.POST) public
